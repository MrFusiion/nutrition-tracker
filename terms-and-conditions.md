...
- __Application__ means the software program provided by the Company downloaded by You on any electronic device, named Belgian Nutrition Tracker
...
- __Country__ refers to:  Belgium
- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Belgian Nutrition Tracker.
...
- By email: fuse-x-fuzionzz@outlook.be